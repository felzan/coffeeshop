...
class UserServiceTest {
    ...
    private static String token = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJmZWx6YW4iLCJpYXQiOjE2MDg1NjE1NzEsImV4cCI6MTYwODU5MDM3MX0.GPZbOmee2tZlytuFDf5v3duL2vEhmPwMAanDdIU-q7A";
    ...
    void login_userPasswordNotMatch() {
        ...
        assertThrows(RuntimeException.class, () -> userService.login(userDTO), "User password not match.");
    }
